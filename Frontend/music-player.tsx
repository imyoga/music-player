...
import { Play, Pause, SkipBack, SkipForward, Volume2, Music, Upload, Square } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="text-center text-white">
          ...
          <p className="text-purple-200">Select and play your favorite tracks</p>
        </div>
        ...
        {currentTrack && (
          <Card className="bg-white/10 backdrop-blur border-white/20">
            <CardContent className="p-6 text-center">
              ...
              <h2 className="text-xl font-semibold text-white mb-2 truncate">{currentTrack.name}</h2>

              {isLoading && <p className="text-purple-200 text-sm mb-4">Loading...</p>}
              ...
              <div className="flex items-center space-x-3 mt-6">
                ...
                <span className="text-white text-sm w-10">{Math.round(volume[0] * 100)}%</span>
              </div>
            </CardContent>
          </Card>
        )}
